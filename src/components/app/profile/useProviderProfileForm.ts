...
import { UpdateProviderInput } from "@/gql/graphql";
...
interface ProfileFormStore {
  ...
  updateInputField: <K extends keyof UpdateProviderInput>(
    field: K,
    value: UpdateProviderInput[K],
  ) => void;
...
export const useProviderProfileStore = create<ProfileFormStore>((set) => ({
  form: initialState,
