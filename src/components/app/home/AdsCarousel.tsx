...
export const AdsCarousel = ({
  ...
  return (
    <div className="grid grid-cols-1 gap-11 overflow-visible py-20">
...
const CategoryCard = ({
  ...
  const dict = useDict();
  return (
    <div className="group grid grid-cols-1 gap-4 pb-2 select-none">
      <div className="relative aspect-284/180 h-45 overflow-hidden rounded-[20px]">
