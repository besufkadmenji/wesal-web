  ...
  return (
    <AppWrapper>
      <div className="relative grid h-50 grid-cols-1">
        ...
        <div className="categorySearch absolute right-0 -bottom-12 left-0 z-10 mx-auto grid w-[48vw] grid-cols-[1fr_auto] items-center justify-center-safe gap-2 rounded-[20px] bg-white p-5">
          <Select
            dir={lng === "ar" ? "rtl" : "ltr"}
