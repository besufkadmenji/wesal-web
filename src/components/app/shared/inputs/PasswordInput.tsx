...
export const PasswordInput = ({
  ...
  return (
    <div className="relative grid h-14 grow grid-cols-1 items-center">
      ...
      <button className="peer-focus-visible:text-primary absolute right-4 left-auto grid size-6 cursor-pointer items-center justify-items-center text-[#999999] rtl:right-auto rtl:left-4">
        {showPassword ? (
          <EyeOpenIcon
